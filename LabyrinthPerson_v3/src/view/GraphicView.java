		...
		try
            {
                ...
                win_screen = ImageIO.read(new File("src/view/resources/win.png"));
				lose_screen = ImageIO.read(new File("src/view/resources/lose.png"));
				bg_img = ImageIO.read(new File("src/view/resources/bg.png"));
				jelly = ImageIO.read(new File("src/view/resources/jelly.png"));
				block = ImageIO.read(new File("src/view/resources/block.png"));

				// animations for fish live in an arraylist
				this.fishBufferedImages = new ArrayList<BufferedImage>();
				String[] paths = {"src/view/resources/fish0.png","src/view/resources/fish0i.png",
									"src/view/resources/fish1.png","src/view/resources/fish1i.png",
										"src/view/resources/fish2.png","src/view/resources/fish2i.png",
											"src/view/resources/fish3.png","src/view/resources/fish3i.png"};
				for (int i = 0; i<8; i++){
